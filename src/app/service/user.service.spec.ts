...
describe('UserService', () => {
  ...
  it('getAccessTokenSilently$ should emit token', (done) => {
  ...
  it('getDecodedAccessToken$ should decode valid token', (done) => {
  ...
  it('getDecodedAccessToken$ should return null on decode error', (done) => {
  ...
  it('retrieveUser should set user property', (done) => {
  ...
  it('retrieveUser should not set user property if not authenticated', (done) => {
  ...
  it('getDecodedAccessToken$ should return null if token is undefined', (done) => {
  ...
  it('getDecodedAccessToken$ should return null if token is empty string', (done) => {
